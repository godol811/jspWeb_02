...
DataSource dataSource;  
	...
	public ArrayList<RoomSearchDto> RoomsearchList(String location, int guest, String roomCheckinDate, String roomCheckoutDate){ //숙소리스트
		...
		try {
			...
			connection = dataSource.getConnection();
			String query = "select round(avg(re.reviewrate),1),r.roomtitle, r.roomcontent, r.roomprice, r.roomcapa, r.roomaddress, r.roomaddressdetail, ";
			...
			while(resultSet.next()) {
				...
				String roomReviewRate = resultSet.getString("round(avg(re.reviewrate),1)");
	...
	public ArrayList<RoomSearchDto> AdminRoomSearch(){ //홈페이지에 있는 바로가기
		ArrayList<RoomSearchDto> dtos = new ArrayList<RoomSearchDto>();
		Connection connection = null;
		PreparedStatement preparedStatement = null;
		ResultSet resultSet = null;
		...
		try {
			// 위에 선언된 dataSource 사용
			connection = dataSource.getConnection();
			String query = "select r.roomtitle, r.roomcontent, r.roomprice, r.roomcapa, r.roomaddress, r.roomaddressdetail,  ";
			String query2 = "r.roomcheckin, r.roomcheckout, r.roomimage, r.roomid, r.roomimagereal from room r";
